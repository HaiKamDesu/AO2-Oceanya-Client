...
namespace OceanyaClient.Features.FileHivemind
{
    public static class FileHivemindBackgroundAgentCommandLine
    {
        ...
        public const string AgentMutexName = FileHivemindAgentProcessContract.AgentMutexName;
        public const string AgentStopSignalEventName = FileHivemindAgentProcessContract.AgentStopSignalEventName;
        public const string AgentStoppedSignalEventName = FileHivemindAgentProcessContract.AgentStoppedSignalEventName;
        public const string AgentExecutableFileName = FileHivemindAgentProcessContract.AgentExecutableFileName;
        public const string MainApplicationExecutableFileName = FileHivemindAgentProcessContract.MainApplicationExecutableFileName;
